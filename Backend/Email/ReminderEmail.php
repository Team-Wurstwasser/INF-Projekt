    ...
    public function sendEmail($toEmail, $toName, $reminderTitle, $reminderMessage, $reminderDate = '')
{
    try {
        ...
        // HTML-Body über die neue private Methode generieren
...
/**
 * Erstellt das HTML-Template als String-Verkettung
 */
                    ...
                    <tr>
                        <td style="padding: 40px; color: #333333; line-height: 1.6;">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td align="center">
                                        <a href="https://deine-website.de/status" class="button">Status prüfen</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
